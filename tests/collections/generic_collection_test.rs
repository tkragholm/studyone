...
use par_reader::common::traits::{ModelCollection, TemporalCollection, LookupCollection};
use par_reader::models::{Individual, Diagnosis};
...
fn test_generic_collection_basic_functions() {
    ...
    // Test filter
    let males = collection.filter(|i| i.gender == "M");
