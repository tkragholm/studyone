...
pub struct PropertyFieldReceiver {
    ...
    data: ast::Data<(), PropertyFieldReceiver>,
}
...
fn generate_property_field_impl(
    ...
    fields: &ast::Fields<PropertyFieldReceiver>,
    ...
    let property_field_setters = fields.iter().filter_map(|field| {
        ...
        // Determine if it's an Option type
        ...
        // Generate getter code based on field type
        let getter_code = generate_field_getter_code(field_name, field_type);
...
fn generate_field_setter_code(field_name: &syn::Ident, field_type: &Type, field_name_str: &str) -> proc_macro2::TokenStream {
...
fn generate_field_getter_code(field_name: &syn::Ident, field_type: &Type) -> proc_macro2::TokenStream {
    quote! {
