...
// use par_reader::models::core::individual::base::Individual;
// use par_reader::registry::unified as unified_factory;
// use std::path::Path;
...
//     info!(
//         "Loaded {} individuals using the unified schema system",
//         individuals.len()
//     );
