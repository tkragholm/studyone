//! Example of IND registry loader implementation using the new trait-based approach
//!
//! This file demonstrates how to migrate the existing IND registry loader
...
// Example of advanced filtering and customization
#[cfg(test)]
mod tests {
    use super::*;
