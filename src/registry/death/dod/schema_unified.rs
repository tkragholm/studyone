...
use crate::schema::field_def::{FieldDefinition, FieldType, FieldMapping};
...
pub fn dod_unified_schema() -> RegistrySchema {
    ...
    let field_mappings = vec![
        ...
        FieldMapping::new(
            FieldDefinition::new("C_AARSAG", "Cause of death (ICD-10 code)", FieldType::String, true),
        ...
        FieldMapping::new(
            FieldDefinition::new("C_TILSTAND", "Underlying cause of death", FieldType::String, true),
