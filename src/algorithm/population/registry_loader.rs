//! Registry data loading for population generation
//!
//! This module handles loading and integrating data from various registry sources
//! to create a comprehensive population dataset.
